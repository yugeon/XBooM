...
use \App\Admin\Model\Form\AddMenuForm,
 \Mockery as m;

class AddMenuFormTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertEquals('addMenu', $this->object->getName());
    }
