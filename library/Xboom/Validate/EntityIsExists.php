...
/**
 * Description of EntityIsExist
 *
 * @author yugeon
 */
namespace Xboom\Validate;

class EntityIsExists extends \Zend_Validate_Abstract
{
    /**
     * Error constants
     */
    const ERROR_NOT_EXISTS = 'notExistsEntity';

    /**
     * @var array Message templates
     */
    protected $_messageTemplates = array(
        self::ERROR_NOT_EXISTS => "No entity matching '%value%' was found",
    );
